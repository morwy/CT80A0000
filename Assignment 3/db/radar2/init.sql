...
DROP DATABASE IF EXISTS radar2_db;
CREATE DATABASE radar2_db;
USE radar2_db;
...
(6,'Custom6_2','Custom Group 6 for DB _2'),
(7,'Custom7_2','Custom Group 7 for DB _2'),
(8,'Custom8_2','Custom Group 8 for DB _2'),
(9,'Custom9_2','Custom Group 9 for DB _2'),
(10,'Custom10_2','Custom Group 10 for DB _2');
...
(6,6,'user6_2','hash6_2',2),
(7,7,'user7_2','hash7_2',2),
(8,8,'user8_2','hash8_2',2),
(9,9,'user9_2','hash9_2',2),
(10,10,'user10_2','hash10_2',2);
...
(9,9,TRUE,TRUE,TRUE,FALSE),
(10,10,FALSE,TRUE,TRUE,FALSE);
...
(6,2,'2025-01-01 00:00:06',20,30,40,0.62),
(7,2,'2025-01-01 00:00:07',21,31,41,0.63),
(8,2,'2025-01-01 00:00:08',22,32,42,0.64),
(9,2,'2025-01-01 00:00:09',23,33,43,0.65),
(10,2,'2025-01-01 00:00:10',24,34,44,0.66);
...
(6,'2025-01-01 10:05:00',6,'LOGIN',2,'USER_ACCOUNT','Custom user6_2 login'),
(7,'2025-01-01 10:06:00',7,'INSERT',2,'AUDIT_LOG','Custom user7_2 insert'),
(8,'2025-01-01 10:07:00',8,'DELETE',2,'RADAR_DETECTION','Custom user8_2 delete attempt'),
(9,'2025-01-01 10:08:00',9,'UPDATE',2,'USER_GROUP','Custom user9_2 updated group'),
(10,'2025-01-01 10:09:00',10,'SELECT',2,'PERMISSION','Custom user10_2 select');
